		...
		<div id="content">
			<div id="user">
				...
				<form id="join-form" name="joinForm" method="POST" action="${pageContext.servletContext.contextPath}/user/join">
					...
					<input type="button" value="id 중복체크" onclick="window.open('${pageContext.servletContext.contextPath}/user?a=checkemail&email=' + document.getElementById('email').value,
