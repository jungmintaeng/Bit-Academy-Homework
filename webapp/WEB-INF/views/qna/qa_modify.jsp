				...
				<form name = "form2" method = "post" action = "">
					<table border="0" cellpadding="0" cellspacing="0" width="690">
						...
						<tr>
							...
							<td width="586">
								&nbsp;&nbsp;<input type="text" autocomplete="off" name="title" maxlength="50" size="85" class="cmfont1" value="글 제목입니다.">
							</td>
						</tr>
						<tr><td colspan="2" height="2"></td></tr>
						...
						<tr>
							...
							<td width="586">
								&nbsp;&nbsp;<input type="text" autocomplete="off" name="name" value="홍길동" size="15" class="cmfont1"><br>
							</td>
						</tr>
						<tr><td colspan="2" height="2"></td></tr>
						<tr><td colspan="2" background="${pageContext.servletContext.contextPath }/assets/images/ln1.gif"></td></tr>
