...
<div class="container" style="margin: 0 auto; width:900px;text-align: center;">
	...
	<hr width='900' size='3'>
	<form name="form1" method="post" action="${cPath}/admin/faq/new" onsubmit="return checkVal()">
		<input type="hidden" name="no" value="${authUser.no}">
		<table width="900" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
			<tr>
				<td width="200" height="20" bgcolor="#CCCCCC" align="center">
					<font color="#142712">제목</font>
				</td>
				<td width="500" height="20"  bgcolor="#F2F2F2">
					&nbsp <input type="text" autocomplete="off" name="title" value="" size="118">
				</td>
			</tr>
			<tr>
				<td width="200" height="20" bgcolor="#CCCCCC" align="center">
					<font color="#142712">내용</font>
				</td>
				<td width="500" bgcolor="#F2F2F2">
					&nbsp <textarea name="content" rows="10" cols="120"></textarea>
				</td>
			</tr>
		</table>
		<br>
