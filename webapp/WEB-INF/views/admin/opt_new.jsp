...
<div class="container" style="margin: 0 auto; width:900px;text-align: center;">
	...
	<hr width='900' size='3'>
	<form name="form1" method="post" action="${cPath}/admin/option/new" onsubmit="return checkVal()">
		...
		<table width="900" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
			<tr>
				...
				<td width="400" height="20"  bgcolor="#F2F2F2">
					<input type="text" autocomplete="off" name="name" value="" size="20" maxlength="20">
				</td>
			</tr>
		</table>
		<br>
		<table width="900" border="0" cellspacing="0" cellpadding="7">
			<tr>
				<td align="center">
					...
					<a href="${cPath}/admin/option/list"><input type="button" value="이 전 화 면"></a>
				</td>
			</tr>
		</table>
