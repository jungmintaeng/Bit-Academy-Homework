...
$(document).ready(function(){
	$(document).on('mouseenter', '#photo-list li', function(){
		$(this).find('a.del-button').show();
	});
	$(document).on('mouseleave', '#photo-list li', function(){
		$(this).find('a.del-button').hide();
	});
	for(i = 1 ; i < 16; i++){
		$('#photo-list').append("<li>" +
		'<a href="${pageContext.request.contextPath }/assets/gallery-examples/im' + i + '.jpg"' +
			'data-lightbox="gallery"' +
			'class="image"' +
			'style="background-image:url(' + "'${pageContext.request.contextPath }/assets/gallery-examples/im" + i +".jpg')" + '">&nbsp;</a>' +
		'<a href="${pageContext.request.contextPath }/gallery/delete/' + i + '"' +
			'class="del-button"' +
			'title="삭제">삭제</a>' + 
	'</li>');
	}
			...
			<div id="gallery">
				<div>
					<div id="gallery-title">
						<img src="${pageContext.request.contextPath }/assets/images/gallery.png">
						<h1>갤러리</h1>
					</div>
